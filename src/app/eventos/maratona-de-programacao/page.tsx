        ...
        <div className="pt-[125px] pb-16 lg:mb-16 mx-10 md:mx-16 lg:mx-24 xl:mx-36 flex flex-col xl:grid xl:grid-cols-12 gap-8 justify-center">
            <div className="order-last xl:order-1 col-span-7 flex flex-col gap-6">
                <div className="flex flex-col items-center">
                    <motion.p initial="hidden" animate="visible" variants={uppV3} className="italic font-light text-sm ">20/03 - Lab 7 LCC</motion.p>
                ...
                <div className="flex flex-col gap-3">
                    ...
                    <div className="flex flex-col md:flex-row gap-3 md:gap-0 justify-between md:mx-2">
                        <motion.div initial="hidden" animate="visible" variants={uppV3} className="w-1/2 md:w-1/3 mx-auto">
                            <Button type="primary" href="https://forms.gle/smT5KtLSoZqYizWv7" target="_blank" className="w-full text-sm md:text-base">Inscreva-se</Button>
                        </motion.div>
