        ...
        <div className="flex flex-col items-center gap-6 mb-24 lg:mb-16">
            ...
            <div className="flex flex-col gap-7 lg:gap-10 md:mx-4 lg:mx-0 xl:mx-20">
                <motion.div initial="hidden" animate="visible" variants={appearV} className="flex flex-col lg:grid lg:grid-cols-12 lg:ml-20 xl:ml-10 2xl:ml-20 lg:mr-16 xl:mr-8 2xl:mr-16 lg:p-7 gap-12 lg:gap-6 bg-slate-200 p-2 rounded-lg lg:items-center">
                    <motion.div initial="hidden" animate="visible" variants={mesaLeftV} className="col-span-4 hidden lg:block">
                        <Image
                ...
                <motion.div initial="hidden" animate="visible" variants={appearV} className="flex lg:grid lg:grid-cols-12 lg:mr-24 lg:ml-16 lg:p-7 gap-12 lg:gap-6 bg-slate-200 p-2 rounded-lg lg:items-center">
                    ...
                    <motion.div initial="hidden" animate="visible" variants={mesaRightV} className="col-span-3 hidden lg:block">
                        <Image
