        ...
        <div className="pt-[125px] px-5 flex flex-col gap-10" >
            <div className="col-span-1 flex flex-col place-self-center gap-3">
                ...
                <div className="flex md:gap-10">
                    <Button
                        onClick={() => { handleSelectedButtonChange("18/03") }}
                        variant="ghost"
                        className={`text-lg ${date === "18/03" ? "bg-gray-200" : ""}`}>
                        18/03/26
                    </Button>
                    <Button
                        onClick={() => { handleSelectedButtonChange("19/03") }}
                        variant="ghost"
                        className={`text-lg ${date === "19/03" ? "bg-gray-200" : ""}`}>
                        19/03/26
                    </Button>
                    <Button
