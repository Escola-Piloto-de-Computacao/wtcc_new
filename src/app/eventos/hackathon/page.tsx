...
import { downV, downV3, appearV } from '@/lib/motion-variants';
                ...
                <Tabs defaultValue='O que é?' className="mt-4 w-full">
                    ...
                    <TabsContent value='O que é?' className="mt-8 lg:mx-6 text-justify">
                        <motion.div initial="hidden" animate="visible" variants={downV} className="flex flex-col gap-4 indent-3">
                            <p>O Hackathon é um evento voltado para a resolução de problemas, a partir de um desafio proposto, onde os participantes têm a oportunidade de desenvolver soluções inovadoras e criativas, utilizando seus conhecimentos, trazendo, ao final, uma proposta a ser apresentada e avaliada por uma banca de jurados.</p>
                            <p>É uma grande oportunidade para os participantes colocarem em prática seus conhecimentos, aprenderem novas tecnologias, trabalharem em equipe, desenvolverem habilidades de comunicação e liderança, além de terem a chance de ganhar prêmios e reconhecimento. O Hackathon é uma experiência única e enriquecedora, que pode abrir portas para novas oportunidades e parcerias.</p>
                            <p>Os Hackathons são eventos muito populares e realizados em todo o mundo, em diversas áreas, como tecnologia, inovação, empreendedorismo, educação, saúde, entre outros. São eventos dinâmicos, intensos e desafiadores, que estimulam a criatividade, a colaboração e o trabalho em equipe, proporcionando uma experiência enriquecedora e transformadora para os participantes.</p>
                            <p>Ao final do evento, os grupos apresentam suas soluções para a banca de jurados, que avalia e escolhe os melhores projetos, as produções vencedoras são premiados. Os Hackathons são uma excelente oportunidade para os participantes mostrarem seu potencial, desenvolverem suas habilidades e competências, e se destacarem no curso.</p>
                        </motion.div>
                    </TabsContent>
                    <TabsContent value='Inscrição' className="mt-8 lg:mx-6 text-justify">
                        <motion.div initial="hidden" animate="visible" variants={downV} className="flex flex-col gap-4 indent-3">
                            ...
                            <div className="mt-2 flex gap-3 indent-0">
                                ...
                                <Button type="primary" className="w-full" href="https://forms.gle/wULc1rNUBbykYAXt5" target="_blank">Formulário de Inscrição</Button>
                            </div>
                        </motion.div>
                    </TabsContent>
