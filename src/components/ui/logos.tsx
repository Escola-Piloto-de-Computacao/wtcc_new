...
const WebLogo = React.forwardRef<
    HTMLDivElement,
    propsWithSize
>(({ className, size = 15, ...props }, ref) => (
    <div
...
WebLogo.displayName = 'WebLogo';

const InicianteLogo = React.forwardRef<
    HTMLDivElement,
    propsWithSize
>(({ className, size = 15, ...props }, ref) => (
    <div
...
InicianteLogo.displayName = 'InicianteLogo';


export { FrontEndLogo, WebLogo, InicianteLogo };