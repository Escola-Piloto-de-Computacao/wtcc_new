                    ...
                    {atividade.pageExists ? (
                        <Link href={`${atividade.page}`}>
                            <div className="flex gap-1">
                                <h3 className="text-[#542A78] text-lg text-center md:text-start font-medium ml-4 sm:ml-0">{atividade.titulo}</h3>
                                <HiCursorClick size={15} className="text-[#542A78]" />
                            </div>
                        </Link>
                    ) : (
                        <h3 className="text-[#542A78] text-lg  text-center md:text-start font-medium">{atividade.titulo}</h3>
                    )}
