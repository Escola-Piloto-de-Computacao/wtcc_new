...
const MaratonaText = () => {
    return (
        <motion.div initial="hidden" animate="visible" variants={uppV2} className="h-full lg:h-[52vh] text-justify indent-6 flex flex-col gap-3 mb-4 lg:mb-0">
            ...
            <p>Para participar da maratona, é necessário formar um grupo de <span className="bg-[#B395CC] px-[0.15rem]">3 alunos</span> e se inscrever no formulário abaixo! A premiação e competição será no <span className="bg-[#B395CC] px-[0.15rem]">dia 20/03, das 8:00 às 12:00</span>.</p>
        </motion.div>
    );
};
