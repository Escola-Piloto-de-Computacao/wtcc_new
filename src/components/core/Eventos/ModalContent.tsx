    ...
    return (
        <div className="w-full grid grid-cols-12 mb-3">
            ...
            <div className="col-span-5">
                <img src={minicourse.picture} alt={minicourse.title} className="w-full h-60" />
            </div>
                    ...
                    <>
                        ...
                        <ul>
                            {minicourse.prerequesites.map((prerequisite, index) => (
                                <li key={index} className="ml-2 text-base tracking-wide">{prerequisite}</li>
                            ))}
                        </ul>
                    </>
                ) : (
            ...
            <div className="col-span-12 mt-7 mx-3">
                {minicourse.palestrantes.length > 1 ? (
                    <div className="flex gap-12 font-mono tracking-tighter">
                        ...
                        <div className="flex flex-col w-1/2">
                            <div className="flex gap-4">
                                <div className="flex flex-col">
                                    <h3 className="text-lg ml-1">{minicourse.palestrantes[1].name}</h3>
                    ...
                    <div className="flex gap-4 font-mono tracking-tighter">
                        ...
                        <div className="flex items-center mx-3 ml-12">
                            <SocialMediaShowcase social={minicourse.palestrantes[0].social} />
                        </div>
                    </div>
                )}
