                ...
                <div className="flex flex-col gap-4 text-medium">
                    <div className="flex flex-col gap-1">
                        ...
                        <ul className="list-disc ml-10 flex flex-col gap-1">
                            <li><span className="font-semibold">Dia 18</span>: <span className="italic">Introdução ao desenvolvimento de jogos com a Godot 4</span>; <span className="italic">Introdução a QA</span>;</li>
                            <li><span className="font-semibold">Dia 19</span>: <span className="italic">Introdução a testes automatizados com Cypress</span></li>
                        </ul>
                    </div>
                    <div className="flex flex-col gap-1">
                        <p>Agora seguem algumas recomendações de minicursos a depender da área de mercado em que deseja ingressar:</p>
                        <ul className="list-disc ml-10 flex flex-col gap-1">
                            <li><span className="font-semibold">Design de Interfaces</span>: <span className="italic">Introdução a Design System: Conceitos e Implementações</span> (para quem quer aprender a produzir designs); <span className="italic">Avaliação de Design de Interfaces</span> (para quem quer entender o que faz uma boa interface)</li>
                            <li><span className="font-semibold">Desenvolvimento de Jogos</span>: <span className="italic">Introdução a Godot 4</span>; ferramenta muito utilizadas no mercado atual</li>
                        </ul>
                    </div>
